...
type StatementStatistics struct {
	...
	PhysPlanUrl    string   `protobuf:"bytes,13,opt,name=phys_plan_url,json=physPlanUrl" json:"phys_plan_url"`
}
...
func (m *StatementStatistics) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x6a
	i++
	i = encodeVarintAppStats(dAtA, i, uint64(len(m.PhysPlanUrl)))
	i += copy(dAtA[i:], m.PhysPlanUrl)
	return i, nil
}
...
func (m *StatementStatistics) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 13:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PhysPlanUrl", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.PhysPlanUrl = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
...
var fileDescriptorAppStats = []byte{
	...
	,
}
