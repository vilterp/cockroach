...
type SpanStatsResponse struct {
	...
	ProblemsByRangeID    map[github_com_cockroachdb_cockroach_pkg_roachpb.RangeID]RangeProblems `protobuf:"bytes,4,rep,name=problems_by_range_id,json=problemsByRangeId,castkey=github.com/cockroachdb/cockroach/pkg/roachpb.RangeID" json:"problems_by_range_id" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
}
...
func (m *SpanStatsResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.ProblemsByRangeID) > 0 {
		keysForProblemsByRangeID := make([]int64, 0, len(m.ProblemsByRangeID))
		for k := range m.ProblemsByRangeID {
			keysForProblemsByRangeID = append(keysForProblemsByRangeID, int64(k))
		}
		sortkeys.Int64s(keysForProblemsByRangeID)
		for _, k := range keysForProblemsByRangeID {
			dAtA[i] = 0x22
			i++
			v := m.ProblemsByRangeID[github_com_cockroachdb_cockroach_pkg_roachpb.RangeID(k)]
			msgSize := 0
			if (&v) != nil {
				msgSize = (&v).Size()
				msgSize += 1 + sovStatus(uint64(msgSize))
...
func (m *CommandQueueResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	n44, err := m.Snapshot.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n44
...
func (m *SpanStatsResponse) Size() (n int) {
	...
	if len(m.ProblemsByRangeID) > 0 {
		for k, v := range m.ProblemsByRangeID {
			_ = k
			_ = v
			l = v.Size()
			mapEntrySize := 1 + sovStatus(uint64(k)) + 1 + l + sovStatus(uint64(l))
...
func (m *SpanStatsResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ProblemsByRangeID", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.ProblemsByRangeID == nil {
				m.ProblemsByRangeID = make(map[github_com_cockroachdb_cockroach_pkg_roachpb.RangeID]RangeProblems)
			}
			var mapkey int64
			mapvalue := &RangeProblems{}
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
			...
			m.ProblemsByRangeID[github_com_cockroachdb_cockroach_pkg_roachpb.RangeID(mapkey)] = *mapvalue
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipStatus(dAtA[iNdEx:])
...
var fileDescriptorStatus = []byte{
	...
	,
}
