...
type TracesIndexResponse struct {
	TxnIdxs []int64 `protobuf:"varint,1,rep,packed,name=txn_idxs,json=txnIdxs" json:"txn_idxs,omitempty"`
}
...
func (m *TracesIndexResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	_ = l
	if len(m.TxnIdxs) > 0 {
		dAtA27 := make([]byte, len(m.TxnIdxs)*10)
		var j26 int
		for _, num1 := range m.TxnIdxs {
			num := uint64(num1)
			for num >= 1<<7 {
...
func (m *TraceResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.StartTime != nil {
		...
		n28, err := m.StartTime.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n28
	...
	if m.RootSpan != nil {
		...
		n29, err := m.RootSpan.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n29
	...
	for iNdEx < l {
		...
		case 1:
			if wireType == 0 {
				...
				return fmt.Errorf("proto: wrong wireType = %d for field TxnIdxs", wireType)
			}
		default:
			iNdEx = preIndex
			skippy, err := skipAdmin(dAtA[iNdEx:])
...
var fileDescriptorAdmin = []byte{
	...
	,
}
