...
type TracesIndexRequest struct {
}

func (m *TracesIndexRequest) Reset()                    { *m = TracesIndexRequest{} }
func (m *TracesIndexRequest) String() string            { return proto.CompactTextString(m) }
func (*TracesIndexRequest) ProtoMessage()               {}
func (*TracesIndexRequest) Descriptor() ([]byte, []int) { return fileDescriptorAdmin, []int{36} }

type TracesIndexResponse struct {
	Listings []*TracesIndexResponse_TraceListing `protobuf:"bytes,1,rep,name=listings" json:"listings,omitempty"`
}

func (m *TracesIndexResponse) Reset()                    { *m = TracesIndexResponse{} }
func (m *TracesIndexResponse) String() string            { return proto.CompactTextString(m) }
func (*TracesIndexResponse) ProtoMessage()               {}
func (*TracesIndexResponse) Descriptor() ([]byte, []int) { return fileDescriptorAdmin, []int{37} }

type TracesIndexResponse_TraceListing struct {
	TxnIdx      int64 `protobuf:"varint,1,opt,name=txn_idx,json=txnIdx,proto3" json:"txn_idx,omitempty"`
	NumMessages int64 `protobuf:"varint,2,opt,name=num_messages,json=numMessages,proto3" json:"num_messages,omitempty"`
}

func (m *TracesIndexResponse_TraceListing) Reset()         { *m = TracesIndexResponse_TraceListing{} }
func (m *TracesIndexResponse_TraceListing) String() string { return proto.CompactTextString(m) }
func (*TracesIndexResponse_TraceListing) ProtoMessage()    {}
func (*TracesIndexResponse_TraceListing) Descriptor() ([]byte, []int) {
	return fileDescriptorAdmin, []int{37, 0}
}

type TraceRequest struct {
	TxnIdx string `protobuf:"bytes,1,opt,name=txn_idx,json=txnIdx,proto3" json:"txn_idx,omitempty"`
}

func (m *TraceRequest) Reset()                    { *m = TraceRequest{} }
func (m *TraceRequest) String() string            { return proto.CompactTextString(m) }
func (*TraceRequest) ProtoMessage()               {}
func (*TraceRequest) Descriptor() ([]byte, []int) { return fileDescriptorAdmin, []int{38} }

type TraceResponse struct {
	TxnIdx    int64                       `protobuf:"varint,1,opt,name=txn_idx,json=txnIdx,proto3" json:"txn_idx,omitempty"`
	StartTime *google_protobuf1.Timestamp `protobuf:"bytes,2,opt,name=start_time,json=startTime" json:"start_time,omitempty"`
	RootSpan  *TraceResponse_Span         `protobuf:"bytes,3,opt,name=root_span,json=rootSpan" json:"root_span,omitempty"`
}

func (m *TraceResponse) Reset()                    { *m = TraceResponse{} }
func (m *TraceResponse) String() string            { return proto.CompactTextString(m) }
func (*TraceResponse) ProtoMessage()               {}
func (*TraceResponse) Descriptor() ([]byte, []int) { return fileDescriptorAdmin, []int{39} }

type TraceResponse_LogMessage struct {
	// TODO(vilterp): use google.protobuf.Timestamp
	AgeNs   int64  `protobuf:"varint,1,opt,name=age_ns,json=ageNs,proto3" json:"age_ns,omitempty"`
	Message string `protobuf:"bytes,2,opt,name=message,proto3" json:"message,omitempty"`
	Tag     string `protobuf:"bytes,3,opt,name=tag,proto3" json:"tag,omitempty"`
}

func (m *TraceResponse_LogMessage) Reset()         { *m = TraceResponse_LogMessage{} }
func (m *TraceResponse_LogMessage) String() string { return proto.CompactTextString(m) }
func (*TraceResponse_LogMessage) ProtoMessage()    {}
func (*TraceResponse_LogMessage) Descriptor() ([]byte, []int) {
	return fileDescriptorAdmin, []int{39, 0}
}

type TraceResponse_Span struct {
	Idx       int64  `protobuf:"varint,1,opt,name=idx,proto3" json:"idx,omitempty"`
	Operation string `protobuf:"bytes,2,opt,name=operation,proto3" json:"operation,omitempty"`
	// TODO(vilterp): use google.protobuf.{Timestamp, Duration}
	AgeNs      int64                       `protobuf:"varint,3,opt,name=age_ns,json=ageNs,proto3" json:"age_ns,omitempty"`
	DurationNs int64                       `protobuf:"varint,4,opt,name=duration_ns,json=durationNs,proto3" json:"duration_ns,omitempty"`
	Log        []*TraceResponse_LogMessage `protobuf:"bytes,5,rep,name=log" json:"log,omitempty"`
	ChildSpans []*TraceResponse_Span       `protobuf:"bytes,6,rep,name=child_spans,json=childSpans" json:"child_spans,omitempty"`
}

func (m *TraceResponse_Span) Reset()                    { *m = TraceResponse_Span{} }
func (m *TraceResponse_Span) String() string            { return proto.CompactTextString(m) }
func (*TraceResponse_Span) ProtoMessage()               {}
func (*TraceResponse_Span) Descriptor() ([]byte, []int) { return fileDescriptorAdmin, []int{39, 1} }
...
func init() {
	...
	proto.RegisterType((*TracesIndexRequest)(nil), "cockroach.server.serverpb.TracesIndexRequest")
	proto.RegisterType((*TracesIndexResponse)(nil), "cockroach.server.serverpb.TracesIndexResponse")
	proto.RegisterType((*TracesIndexResponse_TraceListing)(nil), "cockroach.server.serverpb.TracesIndexResponse.TraceListing")
	proto.RegisterType((*TraceRequest)(nil), "cockroach.server.serverpb.TraceRequest")
	proto.RegisterType((*TraceResponse)(nil), "cockroach.server.serverpb.TraceResponse")
	proto.RegisterType((*TraceResponse_LogMessage)(nil), "cockroach.server.serverpb.TraceResponse.LogMessage")
	proto.RegisterType((*TraceResponse_Span)(nil), "cockroach.server.serverpb.TraceResponse.Span")
...
type AdminClient interface {
	...
	TracesIndex(ctx context.Context, in *TracesIndexRequest, opts ...grpc.CallOption) (*TracesIndexResponse, error)
...
func (c *adminClient) TracesIndex(ctx context.Context, in *TracesIndexRequest, opts ...grpc.CallOption) (*TracesIndexResponse, error) {
	out := new(TracesIndexResponse)
	err := grpc.Invoke(ctx, "/cockroach.server.serverpb.Admin/TracesIndex", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *adminClient) Trace(ctx context.Context, in *TraceRequest, opts ...grpc.CallOption) (*TraceResponse, error) {
	out := new(TraceResponse)
	err := grpc.Invoke(ctx, "/cockroach.server.serverpb.Admin/Trace", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AdminServer interface {
	...
	TracesIndex(context.Context, *TracesIndexRequest) (*TracesIndexResponse, error)
...
func _Admin_TracesIndex_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TracesIndexRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AdminServer).TracesIndex(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cockroach.server.serverpb.Admin/TracesIndex",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AdminServer).TracesIndex(ctx, req.(*TracesIndexRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Admin_Trace_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TraceRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AdminServer).Trace(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cockroach.server.serverpb.Admin/Trace",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AdminServer).Trace(ctx, req.(*TraceRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Admin_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "TracesIndex",
			Handler:    _Admin_TracesIndex_Handler,
		},
		{
			MethodName: "Trace",
			Handler:    _Admin_Trace_Handler,
		},
	},
...
func (m *TracesIndexRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *TracesIndexRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *TracesIndexResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *TracesIndexResponse) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if len(m.Listings) > 0 {
		for _, msg := range m.Listings {
			dAtA[i] = 0xa
			i++
			i = encodeVarintAdmin(dAtA, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(dAtA[i:])
...
func (m *TracesIndexResponse_TraceListing) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *TracesIndexResponse_TraceListing) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if m.TxnIdx != 0 {
		dAtA[i] = 0x8
		i++
		i = encodeVarintAdmin(dAtA, i, uint64(m.TxnIdx))
	}
	if m.NumMessages != 0 {
		dAtA[i] = 0x10
		i++
		i = encodeVarintAdmin(dAtA, i, uint64(m.NumMessages))
	}
	return i, nil
}
...
func (m *TraceRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.TxnIdx) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintAdmin(dAtA, i, uint64(len(m.TxnIdx)))
		i += copy(dAtA[i:], m.TxnIdx)
	}
	return i, nil
}
...
func (m *TraceResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.StartTime != nil {
		dAtA[i] = 0x12
		i++
		i = encodeVarintAdmin(dAtA, i, uint64(m.StartTime.Size()))
	...
	if m.RootSpan != nil {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintAdmin(dAtA, i, uint64(m.RootSpan.Size()))
		n27, err := m.RootSpan.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n27
...
func (m *TraceResponse_LogMessage) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *TraceResponse_LogMessage) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if m.AgeNs != 0 {
		dAtA[i] = 0x8
		i++
		i = encodeVarintAdmin(dAtA, i, uint64(m.AgeNs))
	}
	if len(m.Message) > 0 {
		dAtA[i] = 0x12
		i++
	...
	if len(m.Tag) > 0 {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintAdmin(dAtA, i, uint64(len(m.Tag)))
		i += copy(dAtA[i:], m.Tag)
	}
	return i, nil
}

func (m *TraceResponse_Span) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *TraceResponse_Span) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if m.Idx != 0 {
		dAtA[i] = 0x8
		i++
		i = encodeVarintAdmin(dAtA, i, uint64(m.Idx))
	}
	...
	if m.DurationNs != 0 {
		dAtA[i] = 0x20
		i++
		i = encodeVarintAdmin(dAtA, i, uint64(m.DurationNs))
	}
	if len(m.Log) > 0 {
	...
	if len(m.ChildSpans) > 0 {
		for _, msg := range m.ChildSpans {
			dAtA[i] = 0x32
			i++
			i = encodeVarintAdmin(dAtA, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(dAtA[i:])
...
func (m *TracesIndexRequest) Size() (n int) {
	var l int
	_ = l
	return n
}

func (m *TracesIndexResponse) Size() (n int) {
	var l int
	_ = l
	if len(m.Listings) > 0 {
...
func (m *TracesIndexResponse_TraceListing) Size() (n int) {
	var l int
	_ = l
	if m.TxnIdx != 0 {
		n += 1 + sovAdmin(uint64(m.TxnIdx))
	}
	if m.NumMessages != 0 {
		n += 1 + sovAdmin(uint64(m.NumMessages))
	}
	return n
}
...
func (m *TraceResponse_LogMessage) Size() (n int) {
	var l int
	_ = l
	if m.AgeNs != 0 {
		n += 1 + sovAdmin(uint64(m.AgeNs))
	}
	l = len(m.Message)
	if l > 0 {
		n += 1 + l + sovAdmin(uint64(l))
...
func (m *TraceResponse_Span) Size() (n int) {
	var l int
	_ = l
	if m.Idx != 0 {
		n += 1 + sovAdmin(uint64(m.Idx))
	}
	l = len(m.Operation)
	if l > 0 {
		n += 1 + l + sovAdmin(uint64(l))
	...
	if m.DurationNs != 0 {
		n += 1 + sovAdmin(uint64(m.DurationNs))
	}
	if len(m.Log) > 0 {
		for _, e := range m.Log {
			l = e.Size()
...
func (m *TracesIndexRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TracesIndexRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TracesIndexRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
...
func (m *TracesIndexResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TracesIndexResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TracesIndexResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.Listings = append(m.Listings, &TracesIndexResponse_TraceListing{})
...
func (m *TracesIndexResponse_TraceListing) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TraceListing: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TraceListing: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TxnIdx", wireType)
			}
			m.TxnIdx = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *TraceRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.TxnIdx = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipAdmin(dAtA[iNdEx:])
...
func (m *TraceResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RootSpan", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.RootSpan == nil {
				m.RootSpan = &TraceResponse_Span{}
			}
			if err := m.RootSpan.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *TraceResponse_LogMessage) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field AgeNs", wireType)
			}
			m.AgeNs = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *TraceResponse_Span) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		case 5:
			...
			m.Log = append(m.Log, &TraceResponse_LogMessage{})
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ChildSpans", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ChildSpans = append(m.ChildSpans, &TraceResponse_Span{})
			if err := m.ChildSpans[len(m.ChildSpans)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorAdmin = []byte{
	...
	,
}
