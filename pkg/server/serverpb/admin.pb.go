...
func (*TracesRequest) Descriptor() ([]byte, []int) { return fileDescriptorAdmin, []int{36} }

type TracesResponse struct {
	TransactionTraces []*TracesResponse_TxnTrace `protobuf:"bytes,1,rep,name=transaction_traces,json=transactionTraces" json:"transaction_traces,omitempty"`
}
...
func (*TracesResponse) Descriptor() ([]byte, []int) { return fileDescriptorAdmin, []int{37} }

type TracesResponse_TxnTrace struct {
	TxnIdx   int64                `protobuf:"varint,1,opt,name=txn_idx,json=txnIdx,proto3" json:"txn_idx,omitempty"`
	RootSpan *TracesResponse_Span `protobuf:"bytes,2,opt,name=root_span,json=rootSpan" json:"root_span,omitempty"`
}

func (m *TracesResponse_TxnTrace) Reset()                    { *m = TracesResponse_TxnTrace{} }
func (m *TracesResponse_TxnTrace) String() string            { return proto.CompactTextString(m) }
func (*TracesResponse_TxnTrace) ProtoMessage()               {}
func (*TracesResponse_TxnTrace) Descriptor() ([]byte, []int) { return fileDescriptorAdmin, []int{37, 0} }

type TracesResponse_LogMessage struct {
	// TODO(vilterp): use google.protobuf.Timestamp
	Timestamp string `protobuf:"bytes,1,opt,name=timestamp,proto3" json:"timestamp,omitempty"`
	Message   string `protobuf:"bytes,2,opt,name=message,proto3" json:"message,omitempty"`
}

func (m *TracesResponse_LogMessage) Reset()         { *m = TracesResponse_LogMessage{} }
func (m *TracesResponse_LogMessage) String() string { return proto.CompactTextString(m) }
func (*TracesResponse_LogMessage) ProtoMessage()    {}
func (*TracesResponse_LogMessage) Descriptor() ([]byte, []int) {
	return fileDescriptorAdmin, []int{37, 1}
}

type TracesResponse_Span struct {
	Operation string `protobuf:"bytes,1,opt,name=operation,proto3" json:"operation,omitempty"`
	// TODO(vilterp): use google.protobuf.{Timestamp, Duration}
	Timestamp  string                       `protobuf:"bytes,2,opt,name=timestamp,proto3" json:"timestamp,omitempty"`
	Duration   string                       `protobuf:"bytes,3,opt,name=duration,proto3" json:"duration,omitempty"`
	Log        []*TracesResponse_LogMessage `protobuf:"bytes,4,rep,name=log" json:"log,omitempty"`
	ChildSpans []*TracesResponse_Span       `protobuf:"bytes,5,rep,name=child_spans,json=childSpans" json:"child_spans,omitempty"`
}

func (m *TracesResponse_Span) Reset()                    { *m = TracesResponse_Span{} }
func (m *TracesResponse_Span) String() string            { return proto.CompactTextString(m) }
func (*TracesResponse_Span) ProtoMessage()               {}
func (*TracesResponse_Span) Descriptor() ([]byte, []int) { return fileDescriptorAdmin, []int{37, 2} }
...
func init() {
	...
	proto.RegisterType((*TracesRequest)(nil), "cockroach.server.serverpb.TracesRequest")
	proto.RegisterType((*TracesResponse)(nil), "cockroach.server.serverpb.TracesResponse")
	proto.RegisterType((*TracesResponse_TxnTrace)(nil), "cockroach.server.serverpb.TracesResponse.TxnTrace")
	proto.RegisterType((*TracesResponse_LogMessage)(nil), "cockroach.server.serverpb.TracesResponse.LogMessage")
	proto.RegisterType((*TracesResponse_Span)(nil), "cockroach.server.serverpb.TracesResponse.Span")
...
type AdminClient interface {
	...
	Traces(ctx context.Context, in *TracesRequest, opts ...grpc.CallOption) (*TracesResponse, error)
}
...
func (c *adminClient) Traces(ctx context.Context, in *TracesRequest, opts ...grpc.CallOption) (*TracesResponse, error) {
	out := new(TracesResponse)
	err := grpc.Invoke(ctx, "/cockroach.server.serverpb.Admin/Traces", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Admin_Traces_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TracesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AdminServer).Traces(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cockroach.server.serverpb.Admin/Traces",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AdminServer).Traces(ctx, req.(*TracesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func (m *TracesResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *TracesResponse) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if len(m.TransactionTraces) > 0 {
		for _, msg := range m.TransactionTraces {
			dAtA[i] = 0xa
			i++
			i = encodeVarintAdmin(dAtA, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(dAtA[i:])
...
func (m *TracesResponse_TxnTrace) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *TracesResponse_TxnTrace) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	if m.RootSpan != nil {
		...
		n26, err := m.RootSpan.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n26
...
func (m *TracesResponse_LogMessage) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *TracesResponse_LogMessage) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *TracesResponse_Span) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *TracesResponse_Span) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *TracesResponse) Size() (n int) {
	var l int
	_ = l
	if len(m.TransactionTraces) > 0 {
...
func (m *TracesResponse_TxnTrace) Size() (n int) {
	var l int
	_ = l
	if m.TxnIdx != 0 {
...
func (m *TracesResponse_LogMessage) Size() (n int) {
	var l int
	_ = l
	l = len(m.Timestamp)
	if l > 0 {
...
func (m *TracesResponse_Span) Size() (n int) {
	var l int
	_ = l
	l = len(m.Operation)
	if l > 0 {
...
func (m *TracesResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TracesResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TracesResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.TransactionTraces = append(m.TransactionTraces, &TracesResponse_TxnTrace{})
			if err := m.TransactionTraces[len(m.TransactionTraces)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *TracesResponse_TxnTrace) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TxnTrace: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TxnTrace: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 2:
			...
			if m.RootSpan == nil {
				m.RootSpan = &TracesResponse_Span{}
			}
...
func (m *TracesResponse_LogMessage) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *TracesResponse_Span) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		case 4:
			...
			m.Log = append(m.Log, &TracesResponse_LogMessage{})
		...
		case 5:
			...
			m.ChildSpans = append(m.ChildSpans, &TracesResponse_Span{})
...
var fileDescriptorAdmin = []byte{
	...
	,
}
