...
type TableStatsResponse struct {
	...
	ReplicaCountByNodeId map[github_com_cockroachdb_cockroach_pkg_roachpb.NodeID]int64 `protobuf:"bytes,7,rep,name=replica_count_by_node_id,json=replicaCountByNodeId,castkey=github.com/cockroachdb/cockroach/pkg/roachpb.NodeID" json:"replica_count_by_node_id,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
...
type DataDistributionResponse struct {
	Databases []*DataDistributionResponse_DatabaseInfo `protobuf:"bytes,1,rep,name=databases" json:"databases,omitempty"`
	// By zone name.
...
type DataDistributionResponse_PartitionInfo struct {
	Name                 string                                                        `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	SubPartitions        []*DataDistributionResponse_PartitionInfo                     `protobuf:"bytes,2,rep,name=sub_partitions,json=subPartitions" json:"sub_partitions,omitempty"`
	ReplicaCountByNodeId map[github_com_cockroachdb_cockroach_pkg_roachpb.NodeID]int64 `protobuf:"bytes,3,rep,name=replica_count_by_node_id,json=replicaCountByNodeId,castkey=github.com/cockroachdb/cockroach/pkg/roachpb.NodeID" json:"replica_count_by_node_id,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
}

func (m *DataDistributionResponse_PartitionInfo) Reset() {
	*m = DataDistributionResponse_PartitionInfo{}
}
func (m *DataDistributionResponse_PartitionInfo) String() string { return proto.CompactTextString(m) }
func (*DataDistributionResponse_PartitionInfo) ProtoMessage()    {}
func (*DataDistributionResponse_PartitionInfo) Descriptor() ([]byte, []int) {
	return fileDescriptorAdmin, []int{40, 1}
}

type DataDistributionResponse_IndexInfo struct {
	Name string                                                   `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	ID   github_com_cockroachdb_cockroach_pkg_sql_sqlbase.IndexID `protobuf:"varint,2,opt,name=id,proto3,casttype=github.com/cockroachdb/cockroach/pkg/sql/sqlbase.IndexID" json:"id,omitempty"`
	// By partition name.
	Partitions []*DataDistributionResponse_PartitionInfo `protobuf:"bytes,3,rep,name=partitions" json:"partitions,omitempty"`
	Stats      *TableStatsResponse                       `protobuf:"bytes,4,opt,name=stats" json:"stats,omitempty"`
}

func (m *DataDistributionResponse_IndexInfo) Reset()         { *m = DataDistributionResponse_IndexInfo{} }
func (m *DataDistributionResponse_IndexInfo) String() string { return proto.CompactTextString(m) }
func (*DataDistributionResponse_IndexInfo) ProtoMessage()    {}
func (*DataDistributionResponse_IndexInfo) Descriptor() ([]byte, []int) {
...
type DataDistributionResponse_TableInfo struct {
	...
	DroppedAt    *time.Time                                          `protobuf:"bytes,4,opt,name=dropped_at,json=droppedAt,stdtime" json:"dropped_at,omitempty"`
	Indexes      []*DataDistributionResponse_IndexInfo               `protobuf:"bytes,5,rep,name=indexes" json:"indexes,omitempty"`
}
...
func (*DataDistributionResponse_TableInfo) Descriptor() ([]byte, []int) {
	return fileDescriptorAdmin, []int{40, 3}
}

type DataDistributionResponse_DatabaseInfo struct {
	ID     github_com_cockroachdb_cockroach_pkg_sql_sqlbase.ID `protobuf:"varint,1,opt,name=id,proto3,casttype=github.com/cockroachdb/cockroach/pkg/sql/sqlbase.ID" json:"id,omitempty"`
	Name   string                                              `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`
	Tables []*DataDistributionResponse_TableInfo               `protobuf:"bytes,3,rep,name=tables" json:"tables,omitempty"`
}
...
func (*DataDistributionResponse_DatabaseInfo) Descriptor() ([]byte, []int) {
	return fileDescriptorAdmin, []int{40, 4}
}
...
func init() {
	...
	proto.RegisterType((*DataDistributionResponse_PartitionInfo)(nil), "cockroach.server.serverpb.DataDistributionResponse.PartitionInfo")
	proto.RegisterType((*DataDistributionResponse_IndexInfo)(nil), "cockroach.server.serverpb.DataDistributionResponse.IndexInfo")
...
func (m *TableStatsResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.ReplicaCountByNodeId) > 0 {
		keysForReplicaCountByNodeId := make([]int64, 0, len(m.ReplicaCountByNodeId))
		for k := range m.ReplicaCountByNodeId {
			keysForReplicaCountByNodeId = append(keysForReplicaCountByNodeId, int64(k))
		}
		sortkeys.Int64s(keysForReplicaCountByNodeId)
...
func (m *DataDistributionResponse_PartitionInfo) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *DataDistributionResponse_PartitionInfo) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	if len(m.SubPartitions) > 0 {
		for _, msg := range m.SubPartitions {
			dAtA[i] = 0x12
			i++
			i = encodeVarintAdmin(dAtA, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(dAtA[i:])
...
func (m *DataDistributionResponse_IndexInfo) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *DataDistributionResponse_IndexInfo) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *DataDistributionResponse_PartitionInfo) Size() (n int) {
	var l int
	_ = l
	l = len(m.Name)
	if l > 0 {
...
func (m *DataDistributionResponse_IndexInfo) Size() (n int) {
	var l int
	_ = l
	l = len(m.Name)
	if l > 0 {
...
func (m *DataDistributionResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Databases = append(m.Databases, &DataDistributionResponse_DatabaseInfo{})
...
func (m *DataDistributionResponse_PartitionInfo) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SubPartitions", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SubPartitions = append(m.SubPartitions, &DataDistributionResponse_PartitionInfo{})
			if err := m.SubPartitions[len(m.SubPartitions)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
...
func (m *DataDistributionResponse_IndexInfo) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ID |= (github_com_cockroachdb_cockroach_pkg_sql_sqlbase.IndexID(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 3:
			...
			m.Partitions = append(m.Partitions, &DataDistributionResponse_PartitionInfo{})
...
func (m *DataDistributionResponse_TableInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			...
			m.Indexes = append(m.Indexes, &DataDistributionResponse_IndexInfo{})
			if err := m.Indexes[len(m.Indexes)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
...
func (m *DataDistributionResponse_DatabaseInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.Tables = append(m.Tables, &DataDistributionResponse_TableInfo{})
...
var fileDescriptorAdmin = []byte{
	...
	,
}
