...
import localityIcon from "!!raw-loader!assets/locality.svg";
...
export class StatsView extends React.Component<StatsViewProps> {
  ...
  renderLocalityIcon() {
    return (
      <g transform="translate(14 14)" dangerouslySetInnerHTML={trustIcon(localityIcon)} />
    );
  }
